...
/*
  ...
  Version: V4.0
  Author: Raju
  Author URI: http://.couponfortoday.com
*/
/* Setup the plugin. */
...
function woopss_activate() {
	
	if(get_option('wooproductscroller_prodcat')=='')
	{ add_option('wooproductscroller_prodcat', '', '', 'yes'); }
	if(get_option('wooproductscroller_title')=='')
	{ add_option('wooproductscroller_title', 'True', '', 'yes'); }
	if(get_option('wooproductscroller_no_of_products')=='')
	{ add_option('wooproductscroller_no_of_products', '8', '', 'yes'); }
	if(get_option('wooproductscroller_orderBy')=='')
	{ add_option('wooproductscroller_orderBy', 'prod_title', '', 'yes'); }
	if(get_option('wooproductscroller_order')=='')
	{ add_option('wooproductscroller_order', 'ASC', '', 'yes'); }	

}
register_activation_hook( __FILE__, 'woopss_activate' );
...
<div class="wrap ms-toggle">
  ...
  <table width="50%" class="widefat">
        ...
        <tr>
          <th style="width: 100px;" colspan="2"><h3>If this has helped you and saved your time please consider a help to plugin developer to develop new extraordinary plugin. So, Please donate whatever you can to help us :<div align="center"><a href="https://www.paypal.me/donate627" target="_blank"><img src="<?php echo WOOPRODUCTSCROLLER_URI ?>images/btn_donateCC_LG.gif"/></a></div>
</th>
        </tr>
